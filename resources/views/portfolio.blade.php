 ...
 <section id="portfolio" class="portfolio section-bg">
    <div class="container">
      <div class="section-title">
        <h2>Portfolio</h2>
        <p>Explore my digital playground, where lines of code come to life. From sleek web designs to robust backend functionalities, my portfolio is a testament to my passion for crafting seamless digital experiences. Dive in and discover the intersection of creativity and technology.</p>
      </div>
      ...
      <div class="row portfolio-container">
        ...
        <div class="col-lg-4 col-md-6 portfolio-item filter-web">
          <div class="portfolio-wrap">
            <img src="/img/portfolio/e-voting.jpeg" class="img-fluid" alt="">
            <div class="portfolio-info">
              <h4>Aplikasi E-Voting Ketua Osis</h4>
              <p>Web</p>
            </div>
            <div class="portfolio-links">
              <a href="/img/portfolio/e-voting.jpeg" data-gallery="portfolioGallery" class="portfolio-lightbox" title="Aplikasi E-Voting Ketua Osis"><i class="bx bx-plus"></i></a>
              <a href="portfolio-details.html" title="More Details"><i class="bx bx-link"></i></a>
            </div>
          </div>
        </div>
